  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm p-8">
        ...
        <h2 className="font-display text-xl font-800 text-white drop-shadow-md">{UI_TEXT.SignIn}</h2>
        <p className="mt-1 text-sm text-white/80 drop-shadow">{UI_TEXT.EnterCredentials}</p>

        <form onSubmit={submit} className="mt-6 space-y-4">
          <div>
            <label className="block text-xs font-600 text-white/90 mb-1 drop-shadow">{UI_TEXT.Username}</label>
          ...
          <div>
            <label className="block text-xs font-600 text-white/90 mb-1 drop-shadow">{UI_TEXT.Password}</label>
            <div className="relative">
