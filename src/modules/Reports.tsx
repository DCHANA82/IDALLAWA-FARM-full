...
const ALL_REPORTS: ReportDef[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'Monthly Allowances', header: 'Monthly Allowances' },
      { key: 'Daily Allowances', header: 'Daily Allowances' },
    ...
    getRows: (d, f) => {
      ...
      return sorted.filter(m => !f.year || m.startsWith(f.year)).map((m) => {
        ...
        return {
          ...
          'Monthly Allowances': r.monthlyAllowances,
          'Daily Allowances': r.dailyAllowances,
